...
public class SentimentWords {
    ...
    public boolean initialise(String sFilename, ClassificationOptions options, int iExtraBlankArrayEntriesToInclude) {
        ...
        try {
            ...
            rReader.close();
            sgSentimentWords[++igSentimentWordsCount] = "adroitbct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = 1;
            sgSentimentWords[++igSentimentWordsCount] = "abandonbct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = -1;
            sgSentimentWords[++igSentimentWordsCount] = "affabbct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = 2;
            sgSentimentWords[++igSentimentWordsCount] = "abominabct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = -2;
            sgSentimentWords[++igSentimentWordsCount] = "ecstabct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = 3;
            sgSentimentWords[++igSentimentWordsCount] = "abusebct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = -3;
            sgSentimentWords[++igSentimentWordsCount] = "overjoyedbct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = 4;
            sgSentimentWords[++igSentimentWordsCount] = "devastatbct";
            igSentimentWordsStrengthTake1[igSentimentWordsCount] = -4;
